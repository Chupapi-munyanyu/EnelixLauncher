...
scriptname, versionlaun, usernamelaun, uuidlaun, accessTokenlaun = argv
...
if platform.system() == "Linux":
    ...
    nativesDir = os.getenv('APPDATA')+'\\versions\\'+version+'\\natives'
...
if platform.system() == "Windows":
    javapath = os.path.join(os.getcwd(), 'res\\java\\bin\\javaw.exe')
